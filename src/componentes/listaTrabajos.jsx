                  ...
                  <div className='fixed inset-0 backdrop-blur-sm bg-black bg-opacity-30 flex justify-center items-center'>
                    <div className='bg-white p-5 rounded flex flex-col justify-center items-center gap-5'>
                      ...
                      <input
                        ...
                        onChange={(e) => setTrabajoEditado({ ...trabajoEditado, titulo: e.target.value })}
                      ...
                      <textarea
                        ...
                        onChange={(e) => setTrabajoEditado({ ...trabajoEditado, descripcion: e.target.value })}
                        className="w-full p-2 border rounded"
                      />
                      <label htmlFor="estatusEdit">Estatus:</label>
                      <select
                        id="estatusEdit"
                        value={trabajoEditado.estatus}
                        onChange={(e) => setTrabajoEditado({ ...trabajoEditado, estatus: e.target.value })}
                        className="w-full p-2 border rounded"
                      >
                ...
                {editarModal && trabajoSeleccionado && (
                  <div className='fixed inset-0 backdrop-blur-sm bg-black bg-opacity-30 flex justify-center items-center'>
                    <div className='bg-white p-5 rounded flex flex-col justify-center items-center gap-5'>
                      ...
                      <select
                        id="tipoEdit"
                        value={trabajoEditado.tipo}
                        onChange={(e) => setTrabajoEditado({ ...trabajoEditado, tipo: e.target.value })}
                        className="w-full p-2 border rounded"
                      >
